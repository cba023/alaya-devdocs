...
- The PlatON node has been installed and the node key have been created according to the instructions of [Installing a Node](/alaya-devdocs/en/Install_Node)
- Start the node and [join the PlatON network](/alaya-devdocs/en/Join_PlatON_NetWork)
